...
type AttemptStatus = 'success' | 'fail'
...
const ATTEMPT_STATUSES: AttemptStatus[] = ['success', 'fail']
...
export default function AddCustomExercise() {
  ...
  const [status, setStatus] = useState<AttemptStatus>('success')
  ...
  const isValid = useMemo(() => {
    ...
    return routeName.trim().length > 0 && grade.trim().length > 0 && Number.isFinite(count) && count >= 1
  }, [attemptCount, grade, routeName])
    ...
    <SafeAreaView style={[styles.screen, { backgroundColor: colors.background }]}>
      <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
        ...
        <View style={[styles.card, { backgroundColor: colors.white, borderColor: colors.cardBorder }]}>
          <TextField placeholder="Nom de la voie" type="text" value={routeName} onChangeText={setRouteName} />
          <TextField
            ...
            {CLIMBING_TYPES.map((value) => {
              ...
              return (
                <TouchableOpacity
                  ...
                  style={[styles.segmentButton, { backgroundColor: isActive ? colors.primary : colors.white, borderColor: isActive ? colors.primary : colors.cardBorder }]}
                >
            ...
            {ROUTE_PROFILES.map((value) => {
              ...
              return (
                <TouchableOpacity
                  ...
                  style={[styles.segmentWrapButton, { backgroundColor: isActive ? colors.primary : colors.white, borderColor: isActive ? colors.primary : colors.cardBorder }]}
                >
                  <Text style={[styles.segmentText, { color: isActive ? colors.white : colors.black }]}>{value}</Text>
                </TouchableOpacity>
              )
